            ...
            <div className={style.PhoneAppCheckSection__App}>
                ...
                <div className={style.App__ChoicePart}>
                    ...
                    <div className={style.ChoicePart__description}>
                        ...
                        <p className={style.description__p}>Приложение Яндекса, созданное для пешеходов и тех, кто ездит на общественном транспорте.
            ...
            <div className={style.PhoneAppCheckSection__App}>
                ...
                <div className={style.App__ChoicePart}>
                    ...
                    <div className={style.ChoicePart__description}>
                        ...
                        <p className={style.description__p}>Яндекс.
