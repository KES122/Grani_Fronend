...
const Page2 = () => {
  return (
    ...
    <section className={styles.mainSection}>
        ...
        <button className={styles.mainSection__btnСost} onClick={() => window.location.href = '/Forum2'} >Примерная стоимость: <br />
            15.000 рублей
        </button>
        <h2 className={styles.mainSection__titleVenue}>Примерное место проведения</h2>
        <img className={styles.mainSection__imgYandex} src="img/photo-page2/imageYandex.png" alt="" />
        <h2 className={styles.mainSection__titlePhoto}>Фото с прошлых выездов</h2>
